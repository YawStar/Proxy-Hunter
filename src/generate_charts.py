            ...
            <header class="bg-white rounded-lg shadow-lg p-6 mb-8">
                ...
                <div class="mt-6 bg-blue-50 rounded-lg p-4 flex flex-col items-center justify-center">
                    ...
                    <div class="flex items-center space-x-6 mt-2">
                        <a href="https://github.com/YawStar" target="_blank" class="flex items-center text-gray-700 hover:text-blue-600">
                        ...
                        <a href="https://github.com/YawStar/Proxy-Hunter" target="_blank" class="flex items-center text-gray-700 hover:text-blue-600">
                            <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M12 0C5.374 0 0 5.373 0 12c0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0112 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z"/>
                            </svg>
                            Project Repo
                        </a>
                        <a href="https://t.me/yawhackka" target="_blank" class="flex items-center text-gray-700 hover:text-blue-600">
                            <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
								<path d="M1.101 12.327L22.066 1.841c.513-.257 1.052.174.904.721l-3.565 17.58c-.12.593-.842.825-1.284.412l-5.32-4.983-3.134 3.013c-.22.21-.57.14-.68-.13l-1.954-5.003L1.132 13.56c-.52.19-.54.91-.03 1.233zM12.44 12.3l6.55-6.04c.1-.09-.03-.24-.15-.17l-9.08 5.41 1.76 4.51 1.07-3.71h-.15z"/>
							</svg>
                            Telegram
                        </a>
                    </div>
